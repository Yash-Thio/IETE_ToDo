  ...
  return (
    <div className="flex min-h-screen flex-col bg-zinc-950 text-zinc-100">
      ...
      <main className="flex-1">
        <section className="container py-8 sm:py-12 md:py-16 lg:py-24 xl:py-32 px-4 sm:px-6 lg:px-8">
          <div className="grid gap-8 lg:grid-cols-2 lg:gap-12 xl:gap-16 items-center">
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                ...
                <Button
                  variant="outline"
                  className="border-zinc-700 text-black hover:border-zinc-600 hover:text-zinc-100"
                >
                  Learn more
                </Button>
              </div>
        ...
        <section
          id="features"
          className="container py-8 sm:py-12 md:py-16 lg:py-24 border-t border-zinc-800 px-4 sm:px-6 lg:px-8"
        >
        ...
        <section className="bg-zinc-900 py-8 sm:py-12 md:py-16 lg:py-24">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 lg:gap-8">
            <div className="p-4 sm:p-6 rounded-lg border border-zinc-800 bg-zinc-900">
              ...
              <p className="text-zinc-300">
                &quot;Remindify has completely changed how I manage my tasks.
                The cloud sync means I never lose track of what I need to do,
            ...
            <div className="p-4 sm:p-6 rounded-lg border border-zinc-800 bg-zinc-900">
              ...
              <p className="text-zinc-300">
                &quot;The categorization and priority features help me stay
                focused on what matters most. It&apos;s like having a personal
                assistant keeping me on track.&quot;
              </p>
            </div>
            ...
            <div className="p-4 sm:p-6 rounded-lg border border-zinc-800 bg-zinc-900">
              ...
              <p className="text-zinc-300">
                &quot;As someone who works across multiple devices, the seamless
                sync is a game-changer. Plus, the design is beautiful - it makes
                me want to use it every day!&quot;
              </p>
            </div>
          </div>
        </section>
        ...
        <section
          id="pricing"
          className="bg-zinc-800 text-white py-8 sm:py-12 md:py-16 lg:py-24"
        >
    ...
    <div className="md:hidden">
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 bg-black">
          <div className="fixed right-0 top-0 h-full w-full sm:w-3/4 max-w-sm bg-zinc-950 p-6 sm:p-8 shadow-xl border-l border-zinc-800">
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center gap-2">
                <CheckCircle className="h-6 w-6 text-zinc-300" />
                <span className="text-xl font-bold text-white">Remindify</span>
              </div>
              <Button
                variant="ghost"
                size="icon"
            ...
            <nav className="flex flex-col gap-6">
              <div className="space-y-1">
                ...
                <Link
                  href="#features"
                  className="block py-2 text-base font-medium text-white hover:text-zinc-300 transition-colors"
                  onClick={(e) => {
                    e.preventDefault();
              ...
              <div className="pt-4 border-t border-zinc-800">
                ...
                <div className="space-y-3">
                  <Button
                    variant="outline"
                    className="w-full border-zinc-700 text-white hover:border-zinc-600 hover:text-zinc-300 hover:bg-zinc-800/50"
                  >
                    Log in
                  </Button>
